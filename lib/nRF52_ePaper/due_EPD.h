...
#if !defined(DUE_EPD_H)
#define DUE_EPD_H 1

#include <Arduino.h>
#include <SPI.h>

#if defined(__MSP430_CPU__) || defined(__SAM3X8E__) || defined(NRF52840_XXAA) || defined(__SAM3A8C__)
// #define 
#else
...
#if defined(__AVR_ATmega1280__) || defined(__AVR_ATmega2560__)|| defined(__SAM3X8E__) || defined(NRF52840_XXAA) || defined(__SAM3A8C__)
...
class EPD_Class
{
    ...
    void setFactor(int temperature = 5) {
        this->factored_stage_time = this->stage_time * this->temperature_to_factor_10x(temperature) / 1000; // originally 10 then 1000
    }
    ...
    // assuming a clear (white) screen output an image ( data)
