...
/** Use a combination of cryptographic primitives to deterministically
  ...
  *
  */
bool generateDeterministic256ORIGINAL(BigNum256 out, const uint8_t *seed, const uint32_t chain_lvl_1, const uint32_t chain_lvl_2, const uint32_t chain_lvl_3)
{
	uint8_t i;
...
bool getXPUBfromNodeORIGINAL(BigNum256 out, const uint8_t *seed, const uint32_t num)
{
	uint8_t i;
	uint8_t one_byte; // current byte of seed
