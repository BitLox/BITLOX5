...
#ifndef ASK_STRINGS_H_
#define ASK_STRINGS_H_
...
const unsigned int str_lang_list_UNICODE[][24]  = {
	...
	{0x0020,0x0034,0x002E,0x4E2D,0x6587,0x0020,0x0020,0x0020,0x0020,0x0020,0x0039,0x002E,0x0054,0x00DC,0x0052,0x004B,0x00C7,0x0045},
