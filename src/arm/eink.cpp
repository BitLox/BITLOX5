...
{
    drawtextW3("UNICODE NOT YET SUPPORTED wEDrwUT", 10, 10);
// 	initEink();
...
void writeEinkDisplayUnicode_transactionND(	unsigned int *toDisplayLine0, bool is_progmem0, int l0, int x0, int y0,
											...
											char *toDisplayLine7, bool is_progmem7, int x7, int y7)
{
    drawtextW3("UNICODE NOT YET SUPPORTED wEDrwUTNDis", 10, 10);
// 	#if defined(__MSP430_CPU__) || defined(__SAM3X8E__)|| defined(__SAM3A8C__)|| defined(NRF52840_XXAA)
// 	is_progmem0 = false;
// 	is_progmem1 = false;
// 	is_progmem2 = false;
...
void writeEinkChar(char toDisplay, bool runDisplay, int x, int y)
{
	...
	char * theReference = &toDisplay;
	if(runDisplay)
	{
		drawtextW3(theReference, x, y);
		// EPAPER.display();
	}
}
...
//	initEink();
    drawtextW5(toDisplayLine0, x0, y0);
    drawtextW5(toDisplayLine1, x1, y1);
    drawtextW5(toDisplayLine2, x2, y2);
    drawtextW5(toDisplayLine3, x3, y3);
    drawtextW5(toDisplayLine4, x4, y4);
    drawtextW5(toDisplayLine5, x5, y5);
    drawtextW5(toDisplayLine6, x6, y6);
    drawtextW5(toDisplayLine7, x7, y7);
    drawtextW5(toDisplayLine8, x8, y8);
    drawtextW5(toDisplayLine9, x9, y9);
    drawtextW5(toDisplayLine10, x10, y10);
    drawtextW5(toDisplayLine11, x11, y11);
...
void drawCheck(int x, int y)
{
	...
	drawLine(x+1,y-1,x+6,y+4);
	drawLine(x+1,y,x+6,y+5);
	drawLine(x,y,x+5,y+5);
	drawLine(x,y+1,x+5,y+6);
	drawLine(x-1,y+1,x+4,y+6);

	drawLine(x+7,y+4,x+14,y-3);
	drawLine(x+7,y+3,x+13,y-3);
	drawLine(x+6,y+3,x+13,y-4);
	drawLine(x+6,y+2,x+12,y-4);
...
{
	x = x - 1;
	drawLine(x+5,y+6,x+14,y-3);
	drawLine(x+5,y+5,x+13,y-3);
	drawLine(x+4,y+5,x+13,y-4);
	drawLine(x+4,y+4,x+12,y-4);
	drawLine(x+3,y+4,x+12,y-5);

	drawLine(x+5,y-5,x+14,y+4);
	drawLine(x+5,y-4,x+13,y+4);
	drawLine(x+4,y-4,x+13,y+5);
	drawLine(x+4,y-3,x+12,y+5);
	drawLine(x+3,y-3,x+12,y+6);
}
...
void drawCAPSLOCK(int x, int y)
{
	...
	drawLine(x-3,y+4,x+3,y+4);
	drawLine(x-2,y+3,x+2,y+3);
	drawLine(x-1,y+2,x+1,y+2);
	drawLine(x,y+1,x,y+1);
	fillRectangle(x-2,y+5, 4, 4);
	fillRectangle(x-2,y+10, 4, 2);
}
